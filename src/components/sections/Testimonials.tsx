...
const testimonials = [
  {
    ...
    name: 'Emma Thompson',
    location: 'London, UK',
    quote: 'My experience with Serenity Travel was truly transformative. The Himalayan Retreat provided the perfect balance of relaxation and cultural immersion. The yoga sessions overlooking the mountains were simply breathtaking.',
  ...
  },
  {
    ...
    quote: 'The attention to detail in every aspect of my Bali wellness journey was remarkable. From the organic cuisine to the traditional healing treatments, everything was authentic and rejuvenating.',
  ...
  },
  {
    ...
    quote: 'My Mediterranean retreat exceeded all expectations. The accommodations were luxurious, the staff was attentive, and the wellness programs were expertly designed to leave me feeling renewed and inspired.',
    ...
    <section className="py-20 bg-primary/5 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-serif text-dark mb-3">Guest Testimonials</h2>
          <div className="w-24 h-1 bg-primary mx-auto mb-6"></div>
          <p className="text-lg text-dark/80 max-w-3xl mx-auto">
            Hear from our guests about their transformative experiences with Serenity Travel.
          </p>
        </div>
          ...
          <AnimatePresence mode="wait">
            ...
            >
              <div className="text-center mb-6">
                ...
                <h3 className="text-xl font-medium text-dark">{testimonials[current].name}</h3>
                <p className="text-dark/60 text-sm">{testimonials[current].location}</p>
