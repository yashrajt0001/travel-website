        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-black/80 max-w-xs">
              Experience the journey of a lifetime with our curated luxury travel experiences, tailored to rejuvenate your mind, body, and soul.
            </p>
            <div className="flex space-x-4 pt-2">
              <a href="#" className="text-black hover:text-secondary transition-colors">
          ...
          {/* Quick Links */}
          <div className="space-y-4">
            <h3 className="text-lg font-medium border-b border-white/20 pb-2">Quick Links</h3>
            <ul className="space-y-2 text-black/80">
              ...
              <li>
                <Link href="/accommodations" className="hover:text-secondary transition-colors">
                  Accommodations
                </Link>
              </li>
              <li>
          ...
          {/* Contact Info */}
          <div className="space-y-4">
            <h3 className="text-lg font-medium border-b border-white/20 pb-2">Contact Us</h3>
            <ul className="space-y-3 text-black/80">
              ...
              <li className="flex items-center space-x-3">
                ...
                <a href="mailto:info@serenitytravel.com" className="hover:text-secondary transition-colors">
                  info@serenitytravel.com
                </a>
              </li>
            </ul>
          </div>
          ...
          {/* Newsletter */}
          <div className="space-y-4">
            <h3 className="text-lg font-medium border-b border-white/20 pb-2">Newsletter</h3>
            <p className="text-black/80">
              Subscribe to receive updates on our latest offers and travel inspirations.
            </p>
